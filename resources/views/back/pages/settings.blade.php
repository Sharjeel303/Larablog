                        ...
                        <div>
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <img src="" id="favicon-img-preview" class="img-thumbnail" data-ijabo-default-img="{{ \App\Models\Setting::find(1)->blog_favicon }}">
                                    </div>
                                    <form action="{{ route('author.change-blog-favicon') }}" id="changeBlogFaviconForm" method="POST">
                                        @csrf
                                        <div class="mb-2">
