<div>
            ...
            <div class="row g-2 align-items-center">
                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="d-flex">
                        ...
                        <a href="#" class="btn btn-primary" data-bs-target='#add-author-modal'
    ...
    <div wire:ignore.self class="modal modal-blur fade" id="add-author-modal" tabindex="-1" role="dialog"
        aria-hidden="true">
                ...
                <div class="modal-body">
                    <form wire:submit.prevent='addAuthor()' method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="example-text-input"
                                placeholder="Enter author email" wire:model='email'>
                                <span class="text-danger">@error('email'){{ $message }}@enderror</span>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Username</label>
                            <input type="text" class="form-control" name="example-text-input"
                                placeholder="Enter author username" wire:model='username'>
                  ...
                  <div class="mb-3">
                            ...
                            <div>
                              <label class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="radios-inline" name="direct_publisher" value="0" wire:model='direct_publisher'>
                                <span class="form-check-label">No</span>
                              </label>
                              <label class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="radios-inline" name="direct_publisher" value="1" wire:model='direct_publisher'>
