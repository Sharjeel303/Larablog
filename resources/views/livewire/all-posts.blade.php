    ...
    <div class="row">
        ...
        <div class="row row-cards">
            ...
            <div class="col-md-6 col-lg-3">
                <div class="card">
                    <!-- Add the 'featured-image' class to the image tag -->
                    <img src="/storage/images/post_images/{{$post->featured_image}}" alt="" class="card-img-top featured-image">
...
<style>
    /* Add the CSS to set the width and height of the featured image */
    .featured-image {
        width: 300px; /* Set your desired width here */
        height: 200px; /* Set your desired height here */
        object-fit: cover; /* or 'contain' or 'fill', depending on your preference */
    }
</style>
