...
class AuthorController extends Controller
{
    ...
    public function changeProfilePicture(Request $request)
    {
        ...
        if ($upload) {
            ...
            return response()->json(['status' => 1, 'msg' => 'Your profile picture has been successsfully updated.']);
        } else {
    ...
    public function changeBlogFavicon(Request $request)
    {
        ...
        $filename = time() . '_' . rand(1, 000) . '_larablog_favicon.ico';
        ...
        if ($upload) {
            ...
            return response()->json(['status' => 1, 'msg' => 'Larablog favicon has been successfully updated!']);
        } else {
            return response()->json(['status' => 0, 'msg' => 'Something went wrong']);
        }
