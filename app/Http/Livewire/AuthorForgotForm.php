...
class AuthorForgotForm extends Component
{
    ...
    public function ForgotHandler()
    {
        ...
        $body_message = "We are received a request to reset the password for <b>Larablog</b> account associated with ".$this->email.". <br> You can reset the password by clicking the button below.";
        $body_message .= '<br>';
        ...
        $body_message .='<br>';
        $body_message .='If you did not request for password reset, please ignore this email';
